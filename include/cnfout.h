...
/* Razer e Bruno - métodos PBS e MHF */
void print_thin_gp_based_encoding_PBS2( int layer, int toCreate );
void print_action_based_encoding_MHF( int layer, int toCreate );
void print_action_based_encoding_PBS( int layer, int toCreate );
void print_action_based_encoding_PBS2( int layer, int toCreate );
#endif /* _CNFOUT_H */
