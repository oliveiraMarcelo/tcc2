...
struct Input {
    ...
    Input(int argc, char* argv[]) : domain_(""), problem_("") {
        ...
        // Razer e Bruno
        params_.insert(std::make_pair(std::string("-pbs"), empty));
        // Razer
        params_.insert(std::make_pair(std::string("-mhf"), empty));
        // Razer
        params_.insert(std::make_pair(std::string("-iscas"), empty));
        // Razer
        params_.insert(std::make_pair(std::string("-pure"), empty));
        // Razer
        params_.insert(std::make_pair(std::string("-prefs"), empty));
    ...
    friend std::ostream& operator<<(std::ostream& os, const Input&) {
        os << "==================================================="<< std::endl;
        os << "Support to MHF version.                            "<< std::endl;
        os << "==================================================="<< std::endl;
        ...
        os << "[-iscas X (:bool - 0 normal, 1 means ISCAS)]"           << std::endl;
        os << "[-pbs X (:bool - 0 normal, 1 means PBS)]"           << std::endl;
        os << "[-mhf X (:bool - 0 normal, 1 means MHF)]"           << std::endl;
        os << "[-pure X (:bool - 0 normal, 1 generate pure literals)]"           << std::endl;
        os << "[-prefs X (:integer - 0 off (default), 1 generate one pref var - first one)]"           << std::endl;
